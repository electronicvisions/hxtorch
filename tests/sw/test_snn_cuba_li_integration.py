...
from hxtorch.snn.functional import CUBALIParams, cuba_li_integration
...
class TestLIIntegration(unittest.TestCase):
    ...
    def test_cuba_li_integration(self):
        ...
        membrane, current = cuba_li_integration(graded_spikes, params, dt=1e-6)
    ...
    def test_cuba_li_integration_hw_data(self):
        ...
        # Inject
        graded_spikes = torch.nn.functional.linear(inputs, weight)
        membrane_hw, current = cuba_li_integration(
