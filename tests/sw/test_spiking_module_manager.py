...
class TestModuleManager(unittest.TestCase):
    ...
    def test_add_wrapper(self):
        ...
        wrapper = snn.HXModuleWrapper(None, module1=module1, module2=module2)
    ...
    def test_clear(self):
        ...
        out_handle2 = snn.LIFObservables()
    ...
    def test_handle_wrappers(self) -> None:
        ...
        wrapper = snn.HXModuleWrapper(
            None, module1=module1, module2=module2, module3=module3)
        modules.add_wrapper(wrapper)
    ...
    def test_print(self):
        ...
        modules.add_node(module5, (handle4,), handle6)
        wrapper = snn.HXModuleWrapper(
            None, module2=module2, moudle3=module3, module4=module4)
        modules.add_wrapper(wrapper)
        modules.hw_graph = nx.DiGraph(modules.graph)
