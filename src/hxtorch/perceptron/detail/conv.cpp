...
#include "hxtorch/perceptron/detail/conv1d.h"
#include "hxtorch/perceptron/detail/iterator.h"
#include "hxtorch/perceptron/detail/mac.h"
#include "hxtorch/perceptron/detail/narrow.h"
    ...
    bool const mock)
{
	...
	std::vector<int64_t> const output_size{
	    conv_output_size(input_size, kernel_size, stride, dilation)};
	...
	for (int64_t group_id{0}; group_id < groups; ++group_id) {
		...
		auto result_group = hxtorch::perceptron::matmul(
