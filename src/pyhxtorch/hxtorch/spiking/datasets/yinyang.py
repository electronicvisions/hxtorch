...
class YinYangDataset(Dataset):
    ...
    def which_class(self, x: float, y: float) -> int:
        ...
        :returns: An integer indicating the samples class.
        """
        ...
        criterion2 = d_left > self.r_small and d_left <= 0.5 * self.r_big  # pylint: disable=chained-comparison
